...
import { adicionarEmprestimo, getEmprestimo, updateEmprestimo} from "../../firebase/emprestimos";
...
export function EditarEmprestimo(){
    ...
    useEffect(()=>{
        getLivros().then(busca => { //retorna os livros
            setLivros(busca)
        });
    ...
    return(
        <div className="editar-empretimo">
            <Container>
                ...
                <Form onSubmit={handleSubmit(onSubmit)}>
                    ...
                    <Button type="submit" variant="success mt-2">Editar</Button>
                </Form>
            </Container>
        </div>
    );
